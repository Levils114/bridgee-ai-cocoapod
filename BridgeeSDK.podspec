Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/Levils114/bridgee-ai-cocoapod'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Bridgee.ai' => 'contato@bridgee.ai' }
  s.source           = { :git => 'https://github.com/Levils114/bridgee-ai-cocoapod.git', :tag => s.version.to_s }

  s.ios.deployment_target = '14.0'
  s.swift_version = '5.5'

  s.source_files = 'Sources/BridgeeSDK/**/*.{swift,h,m}'
  s.resources = 'Sources/BridgeeSDK/Resources/**/*'
